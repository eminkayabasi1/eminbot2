...
@Entity
@Table(name = "MD_KATEGORI")
public class MdKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MD_KATEGORI")
    @SequenceGenerator(name="SEQ_MD_KATEGORI", sequenceName = "SEQ_MD_KATEGORI", allocationSize = 1)
    Long id;
