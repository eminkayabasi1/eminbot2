...
@Entity
@Table(name = "MD_CONF")
public class MdConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MD_CONF")
    @SequenceGenerator(name="SEQ_MD_CONF", sequenceName = "SEQ_MD_CONF", allocationSize = 1)
    Long id;
