...
@Entity
@Table(name = "HB_KATEGORI")
public class HbKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_HB_KATEGORI_1")
    @SequenceGenerator(name="SEQ_HB_KATEGORI_1", sequenceName = "SEQ_HB_KATEGORI_1", allocationSize = 1)
    Long id;
    ...
    public Long getIndirimYuzdesi() {
        return indirimYuzdesi;
    }

    public void setIndirimYuzdesi(Long indirimYuzdesi) {
