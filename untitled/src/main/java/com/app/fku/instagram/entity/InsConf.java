...
@Entity
@Table(name = "INS_CONF")
public class InsConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_INS_CONF")
    @SequenceGenerator(name="SEQ_INS_CONF", sequenceName = "SEQ_INS_CONF", allocationSize = 1)
    Long id;
