...
@Entity
@Table(name = "TKN_KATEGORI")
public class TknKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TKN_KATEGORI")
    @SequenceGenerator(name="SEQ_TKN_KATEGORI", sequenceName = "SEQ_TKN_KATEGORI", allocationSize = 1)
    Long id;
