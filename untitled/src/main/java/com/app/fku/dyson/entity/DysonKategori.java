...
@Entity
@Table(name = "DYSON_KATEGORI")
public class DysonKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_DYSON_KATEGORI")
    @SequenceGenerator(name="SEQ_DYSON_KATEGORI", sequenceName = "SEQ_DYSON_KATEGORI", allocationSize = 1)
    Long id;
