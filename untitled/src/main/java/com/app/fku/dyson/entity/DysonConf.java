...
@Entity
@Table(name = "DYSON_CONF")
public class DysonConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_DYSON_CONF")
    @SequenceGenerator(name="SEQ_DYSON_CONF", sequenceName = "SEQ_DYSON_CONF", allocationSize = 1)
    Long id;
