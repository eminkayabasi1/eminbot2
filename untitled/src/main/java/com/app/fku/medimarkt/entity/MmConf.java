...
@Entity
@Table(name = "MM_CONF")
public class MmConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MM_CONF")
    @SequenceGenerator(name="SEQ_MM_CONF", sequenceName = "SEQ_MM_CONF", allocationSize = 1)
    Long id;
