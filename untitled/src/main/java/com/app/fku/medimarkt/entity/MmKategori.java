...
@Entity
@Table(name = "MM_KATEGORI")
public class MmKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MM_KATEGORI")
    @SequenceGenerator(name="SEQ_MM_KATEGORI", sequenceName = "SEQ_MM_KATEGORI", allocationSize = 1)
    Long id;
