...
@Entity
@Table(name = "ITOPYA_CONF")
public class ItopyaConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_ITOPYA_CONF")
    @SequenceGenerator(name="SEQ_ITOPYA_CONF", sequenceName = "SEQ_ITOPYA_CONF", allocationSize = 1)
    Long id;
