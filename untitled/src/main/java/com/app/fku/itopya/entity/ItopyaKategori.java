...
@Entity
@Table(name = "ITOPYA_KATEGORI")
public class ItopyaKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_ITOPYA_KATEGORI")
    @SequenceGenerator(name="SEQ_ITOPYA_KATEGORI", sequenceName = "SEQ_ITOPYA_KATEGORI", allocationSize = 1)
    Long id;
