...
@Entity
@Table(name = "FKU_CONF")
public class FkuConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_FKU_CONF_1")
    @SequenceGenerator(name="SEQ_FKU_CONF_1", sequenceName = "SEQ_FKU_CONF_1", allocationSize = 1)
    Long id;
