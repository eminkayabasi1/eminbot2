...
@Entity
@Table(name = "A101_KATEGORI")
public class A101Kategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_A101_KATEGORI")
    @SequenceGenerator(name="SEQ_A101_KATEGORI", sequenceName = "SEQ_A101_KATEGORI", allocationSize = 1)
    Long id;
