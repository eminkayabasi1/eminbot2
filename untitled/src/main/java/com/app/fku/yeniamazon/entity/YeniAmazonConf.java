...
@Entity
@Table(name = "YENI_AMZ_CONF")
public class YeniAmazonConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_YENI_AMZ_CONF")
    @SequenceGenerator(name="SEQ_YENI_AMZ_CONF", sequenceName = "SEQ_YENI_AMZ_CONF", allocationSize = 1)
    Long id;
