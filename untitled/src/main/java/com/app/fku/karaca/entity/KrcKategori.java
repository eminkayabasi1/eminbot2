...
@Entity
@Table(name = "KRC_KATEGORI")
public class KrcKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_KRC_KATEGORI")
    @SequenceGenerator(name="SEQ_KRC_KATEGORI", sequenceName = "SEQ_KRC_KATEGORI", allocationSize = 1)
    Long id;
