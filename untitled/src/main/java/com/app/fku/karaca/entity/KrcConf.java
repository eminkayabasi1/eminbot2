...
@Entity
@Table(name = "KRC_CONF")
public class KrcConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_KRC_CONF")
    @SequenceGenerator(name="SEQ_KRC_CONF", sequenceName = "SEQ_KRC_CONF", allocationSize = 1)
    Long id;
