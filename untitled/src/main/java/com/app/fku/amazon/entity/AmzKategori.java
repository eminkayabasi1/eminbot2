...
@Entity
@Table(name = "AMZ_KATEGORI")
public class AmzKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_AMZ_KATEGORI")
    @SequenceGenerator(name="SEQ_AMZ_KATEGORI", sequenceName = "SEQ_AMZ_KATEGORI", allocationSize = 1)
    Long id;
    ...
    @Column(name = "AYRAC_VAR_MI")
    EvetHayirEnum ayracVarMi;
    ...
    public EvetHayirEnum getAyracVarMi() {
        return ayracVarMi;
    }

    public void setAyracVarMi(EvetHayirEnum ayracVarMi) {
        this.ayracVarMi = ayracVarMi;
    }

    public String getAyrac() {
        return ayrac;
    }

    public void setAyrac(String ayrac) {
        this.ayrac = ayrac;
    }
}
