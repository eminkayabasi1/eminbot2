...
@Entity
@Table(name = "AMZ_CONF")
public class AmzConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_AMZ_CONF")
    @SequenceGenerator(name="SEQ_AMZ_CONF", sequenceName = "SEQ_AMZ_CONF", allocationSize = 1)
    Long id;
