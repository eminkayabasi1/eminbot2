...
@Entity
@Table(name = "AMZ_WORKER_ISTATISTIK")
public class AmzWorkerIstatistik extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_AMZ_WORKER_ISTATISTIK")
    @SequenceGenerator(name="SEQ_AMZ_WORKER_ISTATISTIK", sequenceName = "SEQ_AMZ_WORKER_ISTATISTIK", allocationSize = 1)
    Long id;
