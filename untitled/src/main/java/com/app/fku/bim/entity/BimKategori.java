...
@Entity
@Table(name = "BIM_KATEGORI")
public class BimKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_BIM_KATEGORI")
    @SequenceGenerator(name="SEQ_BIM_KATEGORI", sequenceName = "SEQ_BIM_KATEGORI", allocationSize = 1)
    Long id;
