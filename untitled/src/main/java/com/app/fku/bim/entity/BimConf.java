...
@Entity
@Table(name = "BIM_CONF")
public class BimConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_BIM_CONF")
    @SequenceGenerator(name="SEQ_BIM_CONF", sequenceName = "SEQ_BIM_CONF", allocationSize = 1)
    Long id;
