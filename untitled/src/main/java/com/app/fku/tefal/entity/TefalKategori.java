...
@Entity
@Table(name = "TEFAL_KATEGORI")
public class TefalKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TEFAL_KATEGORI")
    @SequenceGenerator(name="SEQ_TEFAL_KATEGORI", sequenceName = "SEQ_TEFAL_KATEGORI", allocationSize = 1)
    Long id;
