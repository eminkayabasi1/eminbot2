...
@Entity
@Table(name = "TEFAL_CONF")
public class TefalConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TEFAL_CONF")
    @SequenceGenerator(name="SEQ_TEFAL_CONF", sequenceName = "SEQ_TEFAL_CONF", allocationSize = 1)
    Long id;
