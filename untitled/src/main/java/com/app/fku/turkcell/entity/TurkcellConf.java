...
@Entity
@Table(name = "TURKCELL_CONF")
public class TurkcellConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TURKCELL_CONF")
    @SequenceGenerator(name="SEQ_TURKCELL_CONF", sequenceName = "SEQ_TURKCELL_CONF", allocationSize = 1)
    Long id;
