...
@Entity
@Table(name = "TURKCELL_KATEGORI")
public class TurkcellKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TURKCELL_KATEGORI")
    @SequenceGenerator(name="SEQ_TURKCELL_KATEGORI", sequenceName = "SEQ_TURKCELL_KATEGORI", allocationSize = 1)
    Long id;
