...
@Entity
@Table(name = "TY_KATEGORI")
public class TrendyolKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TY_KATEGORI")
    @SequenceGenerator(name="SEQ_TY_KATEGORI", sequenceName = "SEQ_TY_KATEGORI", allocationSize = 1)
    Long id;
