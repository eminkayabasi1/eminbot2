...
public class TrendyolJSONServiceImpl implements TrendyolJSONService {
    ...
    public void sorgula() throws IOException, InterruptedException {
        ...
        */
        ...
        urlList.add(new LinkModel("https://apigw.trendyol.com/discovery-web-searchgw-service/v2/api/infinite-scroll/sr?wc=108656%2C103665&mb=kurumsal_satici&sst=PRICE_BY_ASC&prc=400-100000", 0.95d));//
