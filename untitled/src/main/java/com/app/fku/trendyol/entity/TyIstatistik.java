...
@Entity
@Table(name = "TY_ISTATISTIK")
public class TyIstatistik extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_TY_ISTATISTIK")
    @SequenceGenerator(name="SEQ_TY_ISTATISTIK", sequenceName = "SEQ_TY_ISTATISTIK", allocationSize = 1)
    Long id;
