...
@Entity
@Table(name = "VATAN_KATEGORI")
public class VatanKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_VATAN_KATEGORI")
    @SequenceGenerator(name="SEQ_VATAN_KATEGORI", sequenceName = "SEQ_VATAN_KATEGORI", allocationSize = 1)
    Long id;
