...
@Entity
@Table(name = "VATAN_CONF")
public class VatanConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_VATAN_CONF")
    @SequenceGenerator(name="SEQ_VATAN_CONF", sequenceName = "SEQ_VATAN_CONF", allocationSize = 1)
    Long id;
