...
@Entity
@Table(name = "GC_KATEGORI")
public class GcKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_GC_KATEGORI")
    @SequenceGenerator(name="SEQ_GC_KATEGORI", sequenceName = "SEQ_GC_KATEGORI", allocationSize = 1)
    Long id;
