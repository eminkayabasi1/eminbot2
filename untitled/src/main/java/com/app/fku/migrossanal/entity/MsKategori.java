...
@Entity
@Table(name = "MS_KATEGORI")
public class MsKategori extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MS_KATEGORI")
    @SequenceGenerator(name="SEQ_MS_KATEGORI", sequenceName = "SEQ_MS_KATEGORI", allocationSize = 1)
    Long id;
