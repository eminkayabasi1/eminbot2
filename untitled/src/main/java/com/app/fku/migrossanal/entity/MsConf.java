...
@Entity
@Table(name = "MS_CONF")
public class MsConf extends BaseEntity {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "SEQ_MS_CONF")
    @SequenceGenerator(name="SEQ_MS_CONF", sequenceName = "SEQ_MS_CONF", allocationSize = 1)
    Long id;
